...
export default function LicensePurchase({
  ...
  const {storyWallet, getStoryAddress, disconnectStoryWallet} = useDualWallets()
          ...
          <div className='mt-3 p-3 glass rounded-lg border border-[var(--accent-cyan)]/50 bg-[var(--accent-cyan)]/10'>
            <div className='flex items-center justify-between'>
              ...
              <button
                ...
                title='Disconnect Story wallet and clear address'
              >
                Disconnect
              </button>
            </div>
        ...
        <div className='flex justify-between items-center mb-2'>
          ...
          <span className='font-semibold'>
            {isLoadingCost ? (
              ...
              <span className='text-[var(--accent-cyan)]'>{ethCost} ETH</span>
            ) : (
