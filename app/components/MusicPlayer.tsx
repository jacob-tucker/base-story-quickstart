  ...
  return (
    <div className="glass rounded-2xl overflow-hidden glow-border">
      ...
      <div className="p-6">
        ...
        {/* IP Asset Badge */}
        <div className="mb-6 p-4 glass rounded-xl border border-[var(--accent-purple)]/30">
          ...
          <div className="space-y-3 text-sm">
            <div className="flex items-center justify-between p-3 glass rounded-lg border border-[var(--border-primary)]">
              <span className="text-[var(--text-secondary)]">Asset ID:</span>
              <a
          ...
          <div className="mt-4 p-3 glass rounded-lg border border-[var(--border-primary)]">
            <h5 className="text-sm font-medium text-[var(--text-primary)] mb-3">License Terms</h5>
            <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-xs">
              <div className="flex justify-between">
                <span className="text-[var(--text-muted)]">License Price:</span>
                <span className="text-[var(--accent-cyan)] font-mono">0.00001 $WIP</span>
              </div>
              <div className="flex justify-between">
                <span className="text-[var(--text-muted)]">Commercial Rev Share:</span>
                <span className="text-[var(--accent-cyan)] font-mono">0%</span>
              </div>
              <div className="flex justify-between">
                <span className="text-[var(--text-muted)]">Commercial Use:</span>
                <span className="text-[var(--accent-cyan)] font-mono">✓ true</span>
              </div>
              <div className="flex justify-between">
                <span className="text-[var(--text-muted)]">Derivatives Allowed:</span>
                <span className="text-[var(--accent-cyan)] font-mono">✓ true</span>
              </div>
              <div className="flex justify-between">
                <span className="text-[var(--text-muted)]">AI Training:</span>
                <span className="text-[var(--text-muted)] font-mono">✗ false</span>
              </div>
              <div className="flex justify-between">
